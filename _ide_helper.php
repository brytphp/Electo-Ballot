...
')
     ...
     */ 
         ...
         * @template TWhenParameter
         * @template TWhenReturnType
         * @param \AshAllenDesign\ShortURL\Classes\(\Closure($this):  TWhenParameter)|TWhenParameter|null  $value
         * @param \AshAllenDesign\ShortURL\Classes\(callable($this,  TWhenParameter): TWhenReturnType)|null  $callback
         * @param \AshAllenDesign\ShortURL\Classes\(callable($this,  TWhenParameter): TWhenReturnType)|null  $default
         * @return $this|\AshAllenDesign\ShortURL\Classes\TWhenReturnType 
         * @static 
         */ 
        public static function when($value = null, $callback = null, $default = null)
        {
         ...
         * @template TUnlessParameter
         * @template TUnlessReturnType
         * @param \AshAllenDesign\ShortURL\Classes\(\Closure($this):  TUnlessParameter)|TUnlessParameter|null  $value
         * @param \AshAllenDesign\ShortURL\Classes\(callable($this,  TUnlessParameter): TUnlessReturnType)|null  $callback
         * @param \AshAllenDesign\ShortURL\Classes\(callable($this,  TUnlessParameter): TUnlessReturnType)|null  $default
         * @return $this|\AshAllenDesign\ShortURL\Classes\TUnlessReturnType 
         * @static 
         */ 
        public static function unless($value = null, $callback = null, $default = null)
        {
