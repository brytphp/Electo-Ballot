    ...
    <main>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;">
            <thead>
                ...
                <tr>
                    ...
                    <td class="desc">
                        {{ $election->start_date->format('d M Y h:m:s a')}} - {{ $election->end_date->format('d M Y h:m:s a')}}</td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                    <th class="no" style="text-align:left;">Total Skipped Votess</th>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                @if ($skipped > 0)
                    <tr>
                    <td class="no" style="text-align:center"><strong>No Votes</strong></td>
                    <td class="desc"> &nbsp; </td>
                ...
                <thead>
                    <tr>
                        <th class="no" style="text-align:left;">
                            {{ $position->top_candidates()->count() > 1 ? 'CANDIDATES':'CANDIDATE' }} ELECTED</th>
                    </tr>
                </thead>
            </table>
        ...
        <div id="notices" style="text-align:left">
            <table border="0" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                        <th class="no" style="text-align:left;"><strong> {{ $position->top_candidates()->count() > 1 ? 'CANDIDATES':'CANDIDATE' }} ELECTED </strong>
        ...
        <div id="notices">
            <img src="{{ base_path('public/theme/images/logo-dark.png') }}" style="height: 17px; wideth: 100%;" />
