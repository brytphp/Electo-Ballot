                ...
                <div class="card textcenter">
                    <div class="">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" name="email_update" value="1"
                                            class="custom-control-input  @error('email_update') is-invalid @enderror" id="email_update"
                                            {{ old('email_update') == '1' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" name="phone_update" value="1"
                                            class="custom-control-input @error('phone_update') is-invalid @enderror" id="phone_update"
                                            {{ old('phone_update') == '1' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" name="voter_inclusion" value="1"
                                            class="custom-control-input @error('voter_inclusion') is-invalid @enderror" id="voter_inclusion"
                                            {{ old('voter_inclusion') == '1' ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <label for="voter_id">Membership Id</label>
                                <input type="text" name="voter_id"
                                    class="form-control @error('voter_id') is-invalid @enderror" id="voter_id" maxlength="6"
                                    placeholder="Your member id" value="{{ old('voter_id') }}" autofocus required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone"
                                    class="form-control @error('phone') is-invalid @enderror" id="phone" maxlength="10"
                                    placeholder="Your phone" value="{{ old('phone') }}" autofocus required
                                    autocomplete="phone">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="card-footer bg-transparent border-top">
                        <div class="contact-links d-flex font-size-20">
                            ...
                            <div class="flex-fill">
                                <button type="submit" class="btn float-right btn-outline-dark waves-effect waves-light">
                                    Submit
                                </button>
                            </div>
                        </div>
